            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.course.store') }}" method="post">
                        @csrf
                        <p>
                            <x-form.input type="date" name="day" placeholder="19/08/23" label="Day"/>
                        </p>
                        <p>
                            <x-form.input type="time" name="begin" placeholder="08:00:00" label="Begin"/>
                            {{-- <input placeholder="Firstname" name="firstname" value="{{ old('firstname') }}"> --}}
                        </p>
                        <p>
                            <x-form.input type="time" name="end" placeholder="10:00:00" label="End"/>
                            {{-- <input placeholder="Email" name="email" value="{{ old('email') }}"> --}}
                        </p>
                        <p>
                            <x-form.input name="libelle" placeholder="WEB 3" label="Libelle"/>
