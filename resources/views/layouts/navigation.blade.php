<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.student.index')" :active="request()->routeIs('admin.student.index')">
                {{ __('Student') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('admin.formation.index')" :active="request()->routeIs('admin.formation.index')">
                {{ __('Formation') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('admin.group.index')" :active="request()->routeIs('admin.group.index')">
                {{ __('Group') }}
            </x-responsive-nav-link>
